CLASS LHC_ZR_A01FLIGHT DEFINITION INHERITING FROM CL_ABAP_BEHAVIOR_HANDLER.
  PRIVATE SECTION.
    METHODS:
...
CLASS LHC_ZR_A01FLIGHT IMPLEMENTATION.
  ...
  READ ENTITIES OF ZR_A01Flight IN LOCAL MODE
  ENTITY Flight
    FIELDS ( Price )
